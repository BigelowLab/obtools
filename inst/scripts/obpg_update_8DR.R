# usage: obpg_create_8DR [--] [--help] [--config_filename CONFIG_FILENAME] [--config_path CONFIG_PATH] [--root_data_path
#                                                                                                       ROOT_DATA_PATH]
# 
# obpg 8DR creator
# 
...
# 
# optional arguments:
#   -c, --config_filename  config_filename identifies the config file [default: nwa_AQUA_4km_8DR_create.yaml]
...
avg     <- function(Q, filename) {
  stars::st_apply(concat(Q), seq_len(2),
                  mean,
                  na.rm = TRUE) |>
...
args = argparser::arg_parser("obpg 8DR creator",
                             name = "obpg_create_8DR",
                             hide.opts = TRUE) |>
